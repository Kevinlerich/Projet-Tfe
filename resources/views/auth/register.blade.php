        ...
        <div class="col-lg-5 col-md-8 align-item-center">
          <div class="border">
            ...
            <form action="{{ route('register') }}" method="post">
                @csrf
              <fieldset class="p-4">
                <input class="mb-3 form-control" type="text" name="name" value="{{ old('name') }}" placeholder="Noms" required>
                ...
                <input class="mb-3 form-control" type="tel" name="telephone" value="{{ old('telephone') }}" placeholder="telephone" required>
                ...
                <div class="my-3 loggedin-forgot d-inline-flex">
                  <input type="checkbox" id="registering" name="terms" required class="mt-1">
                  <label for="registering" class="px-2">En créant votre compte, vous acceptez les termes et conditions d'utilisation. <a class="text-primary font-weight-bold" href="terms-condition.html">Terms & Conditions</a></label>
                </div>
