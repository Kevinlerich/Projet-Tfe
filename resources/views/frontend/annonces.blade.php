    ...
    <div class="a8 a1K a1x ab[-16px]">
        ...
        <div class="a7 lg:a2q/12 ae">
            <div>
                ...
                <a href="{{ route('detail_annonce', $annonce->slug)}}">
                    {{ $annonce->titre }}
                </a>
                </h2>
                ...
                <div class="a8 a1K a9">
                    <div class="a8 a9 a2N a2v">
                        ...
                        <div class="a7">
                            <h4 class=" aH a1R a1S a2K">
                                Ajouté {{ $annonce->created_at->diffForHumans() }} Par
                                <a href="javascript:void(0)" class="a1S hover:a1W">
                                    {{ Auth::user()->name == $annonce->user->name ? 'Vous' : $annonce->user->name }}
                                </a>
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="sm:a8 a9 ac">
                        ...
                        <div class="a2v">
                            <h5 class=" a1R a1S a1b sm:a2H a30">
                                Partager cette annonce :
                            </h5>
                            <div class="a8 a9 sm:a1d">
                                <a href="https://www.linkedin.com/share?url={{ route('detail_annonce', $annonce->slug) }}" class=" aM a9 a1x a1s a1t sm:a32 a13 a1k a29 a1S hover:a31 hover:aI">
                                ...
                                <a href="https://twitter.com/share?url={{ route('detail_annonce', $annonce->slug) }}" class=" aM a9 a1x a1s a1t a32 a13 a1k a29 a1S hover:a31 hover:aI">
                                ...
                                <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('detail_annonce', $annonce->slug) }}" class=" aM a9 a1x a1s a1t a32 a13 a1k a29 a1S hover:a31 hover:aI">
