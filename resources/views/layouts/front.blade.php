								...
								<form>
									<div class="form-row">
										<div class="form-group col-xl-4 col-lg-3 col-md-6">
											<input type="text" class="my-2 form-control my-lg-1" id="inputtext4"
										...
										<div class="form-group col-lg-3 col-md-6">
											<input type="text" class="my-2 form-control my-lg-1" id="inputLocation4" placeholder="Location">
										</div>
...
<footer class="footer section section-sm">
  ...
  <div class="container">
    <div class="row">
      <div class="mb-4 col-lg-3 col-md-7 offset-md-1 offset-lg-0 mb-lg-0">
        <!-- About -->
      ...
      <!-- Link list -->
      <div class="mb-4 col-lg-2 offset-lg-1 col-md-3 col-6 mb-lg-0">
        <div class="block">
          <h4>Site Pages</h4>
          <ul>
      ...
      <!-- Link list -->
      <div class="mb-4 col-lg-2 col-md-3 offset-md-1 offset-lg-0 col-6 mb-md-0">
        <div class="block">
          <h4>Admin Pages</h4>
          <ul>
      ...
      <div class="col-lg-4 col-md-7">
        ...
        <div class="block-2 app-promotion">
          ...
          <div class="my-3 download-btn d-flex">
