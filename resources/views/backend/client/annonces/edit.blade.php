                    ...
                    <form action="{{ route('update_annonce', $annonce->id) }}" method="post">
                        ...
                        <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="date" name="date_announce" id="date_announce" min="<?php echo date('Y-m-d') ?>" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>

                            <div class="sm:col-span-3">
                                <label for="description" class="block text-sm font-medium leading-6 text-gray-900">Description <em>( presier le lieu en cas d'evenement(exteireur ou interieur ) et la date , nombre dheures , et s'il ya autres choses que le photographe devrait savoir )</em></label>
                                <div class="mt-2">
