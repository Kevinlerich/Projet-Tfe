                    ...
                    <form action="{{ route('update_agenda', $annonce->id) }}" method="post">
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="time" name="debut" id="titre" value="{{ $agenda->debut }}" autocomplete="titre" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            <div class="sm:col-span-3">
                                <label for="titre" class="block text-sm font-medium leading-6 text-gray-900">{{ __('Heure de fin') }}</label>
                                <div class="mt-2">
                                    <input type="time" name="fin" id="titre" value="{{ $agenda->fin }}" autocomplete="titre" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                        </div>
