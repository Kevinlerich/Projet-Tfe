    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                @endif
                <a href="{{ route('create_disponibility') }}" class="btn btn-blue bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3 mx-4">
                    ...
                    @foreach($disponibilities as $key => $announce)
                        <tr>
                            ...
                            <td class="px-4 py-2 text-center">
                                <a href="{{ route('edit_disponibility', $announce->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                    {{ __('Modifier') }}
                                </a>
