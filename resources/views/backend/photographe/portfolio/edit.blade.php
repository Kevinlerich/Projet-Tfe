                    ...
                    <form action="{{ route('update_portfolio', $portfolio->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="file" data-preview-file-type="text" name="chemin_photo[]" multiple id="chemin_photo" class="file block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
